...
fig3.savefig("RFoptimize/RF error.svg")
...
plt.subplots_adjust(right=0.95)
plt.subplots_adjust(top=0.95)
fig.savefig("RFoptimize/RF result.svg")
...
plt.savefig("RFoptimize/feature importance.svg")
df.to_csv("RFoptimize/importance score.csv")
