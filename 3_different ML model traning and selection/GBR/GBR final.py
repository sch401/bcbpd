...
GBR = GradientBoostingRegressor(learning_rate=0.15, n_estimators=80)
...
fig.savefig("gbroptimize\GBR CV predicted.svg")
...
sns.barplot(score2)
ax.set(xlabel="Round in CV of GBR", ylabel="MAPE in test")
ax.set_ylim([0, 0.18])
from matplotlib.ticker import MultipleLocator
...
fig3.savefig("gbroptimize\GBR error.svg")
